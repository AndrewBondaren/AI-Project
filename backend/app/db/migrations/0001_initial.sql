...
CREATE TABLE IF NOT EXISTS worlds (
    ...
    fine_cells_per_map_cell     INTEGER NOT NULL DEFAULT 1000,
...
CREATE TABLE IF NOT EXISTS named_locations (
    ...
    typical_districts       TEXT,
    system_settlement_specializations TEXT,
    ...
    frontage_type_order     TEXT,
    structure_counts        TEXT,
    structure_priority      TEXT,
