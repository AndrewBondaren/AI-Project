...
_CANONICAL_ENTRIES: tuple[TerrainRegistryEntry, ...] = (
    ...
    TerrainRegistryEntry(
        system_terrain="shore_river",
        glossary_ref="terrain_shore_river",
        terrain_category="solid",
        travel_modifier=1.8,
        danger_level="low",
        default_material="sand",
    ...
    TerrainRegistryEntry(
        system_terrain="shore_mountain_river",
        glossary_ref="terrain_shore_mountain_river",
        terrain_category="solid",
        travel_modifier=2.0,
        danger_level="medium",
        default_material="stone",
    ...
    TerrainRegistryEntry(
        system_terrain="shore_lake",
        glossary_ref="terrain_shore_lake",
        terrain_category="solid",
        travel_modifier=1.8,
        danger_level="low",
        default_material="sand",
    ...
    TerrainRegistryEntry(
        system_terrain="shore_sea",
        glossary_ref="terrain_shore_sea",
        terrain_category="solid",
        travel_modifier=1.8,
        danger_level="low",
        default_material="sand",
