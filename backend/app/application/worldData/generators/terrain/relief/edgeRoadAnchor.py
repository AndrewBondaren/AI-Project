...
``abutment = seed - outward``; must be ∈ ``road_cells``. Not centerline / not
...
class EdgeRoadAnchor:
    """One seed's edge abutment on the painted road footprint."""
