"""WORLD_SURFACE_GRID axis labels — gx/gy indices; fine-grid span as annotation."""
...
def format_grid_header(
    ...
    *,
    ...
    lines.append(head)
    if fine_span:
        mx0, mx1 = gx0 * fine_span, (gx1 + 1) * fine_span
        my0, my1 = gy0 * fine_span, (gy1 + 1) * fine_span
        lines.append(
            f"{prefix}fine x: {mx0}..{mx1}  y: {my0}..{my1}  (fine_span={fine_span})",
        )
    return "\n".join(lines)
